...
features_incorporated = '[{"name":"enable-multiple-record-types","base":"v2.2.1"}]'

oarepo_major_version = "12"

package_oarepo_version = "oarepo-2.4.0"

configuration = '{"name": "invenio-oaiserver", "oarepo": 12, "features": [{"name": "enable-multiple-record-types", "base": "v2.2.1"}], "package": "invenio-oaiserver", "invenio_version": "2.4.0", "version": "2.4.0"}'
